...
pub const LIBRARY_NO_ERROR: ::std::os::raw::c_int = 0;
pub const LIBRARY_TYPE_ERROR: ::std::os::raw::c_int = 1;
pub const LIBRARY_RANK_ERROR: ::std::os::raw::c_int = 2;
pub const LIBRARY_DIMENSION_ERROR: ::std::os::raw::c_int = 3;
pub const LIBRARY_NUMERICAL_ERROR: ::std::os::raw::c_int = 4;
pub const LIBRARY_MEMORY_ERROR: ::std::os::raw::c_int = 5;
pub const LIBRARY_FUNCTION_ERROR: ::std::os::raw::c_int = 6;
pub const LIBRARY_VERSION_ERROR: ::std::os::raw::c_int = 7;
