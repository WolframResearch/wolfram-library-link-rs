...
pub const WolframLibraryVersion: u32 = 8;
...
pub struct st_WolframLibraryData {
    ...
    pub tabularColumnLibraryFunctions: *mut st_WolframTabularColumnLibrary_Functions,
...
fn bindgen_test_layout_st_WolframLibraryData() {
    ...
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).tabularColumnLibraryFunctions) as usize
                - ptr as usize
        },
        392usize,
        concat!(
            ...
            stringify!(st_WolframLibraryData),
            "::",
            stringify!(tabularColumnLibraryFunctions)
        )
    );
    assert_eq!(
        unsafe {
...
extern "C" {
    pub fn MNumericArray_newDLL(
        type_: numericarray_data_t,
        rank: mint,
        dims: *const mint,
        res: *mut MNumericArray,
    ) -> errcode_t;
}
extern "C" {
    pub fn MNumericArray_clone(from: MNumericArray, to: *mut MNumericArray) -> errcode_t;
}
extern "C" {
    pub fn MNumericArray_free(narray: MNumericArray);
}
extern "C" {
    pub fn MNumericArray_disown(narray: MNumericArray);
}
extern "C" {
    pub fn MNumericArray_disownAll(narray: MNumericArray);
}
extern "C" {
    pub fn MNumericArray_shareCount(narray: MNumericArray) -> mint;
}
extern "C" {
    pub fn MNumericArray_getTypeDLL(narray: MNumericArray) -> numericarray_data_t;
}
extern "C" {
    pub fn MNumericArray_getRankDLL(narray: MNumericArray) -> mint;
}
extern "C" {
    pub fn MNumericArray_getDimensionsDLL(narray: MNumericArray) -> *const mint;
}
extern "C" {
    pub fn MNumericArray_getFlattenedLength(narray: MNumericArray) -> mint;
}
extern "C" {
    pub fn MNumericArray_getData(narray: MNumericArray) -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn MNumericArray_convertType(
        outP: *mut MNumericArray,
        narray: MNumericArray,
        result_type: numericarray_data_t,
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct TabularColumn_struct {
    _unused: [u8; 0],
}
pub type TabularColumn = *mut TabularColumn_struct;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct st_WolframIOLibrary_Functions {
    ...
    >,
    pub DataStore_addNamedTabularColumn: ::std::option::Option<
        unsafe extern "C" fn(
            arg1: DataStore,
            arg2: *mut ::std::os::raw::c_char,
            arg3: TabularColumn,
    ...
    >,
    pub DataStore_addTabularColumn:
        ::std::option::Option<unsafe extern "C" fn(arg1: DataStore, arg2: TabularColumn)>,
}
#[test]
fn bindgen_test_layout_st_WolframIOLibrary_Functions() {
    ...
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).DataStore_addNamedTabularColumn) as usize
                - ptr as usize
        },
        304usize,
        concat!(
            ...
            stringify!(st_WolframIOLibrary_Functions),
            "::",
            stringify!(DataStore_addNamedTabularColumn)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).DataStore_addTabularColumn) as usize
                - ptr as usize
        },
        312usize,
        concat!(
            ...
            stringify!(st_WolframIOLibrary_Functions),
            "::",
            stringify!(DataStore_addTabularColumn)
        )
    );
}
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct st_WolframTabularColumnLibrary_Functions {
    pub _address: u8,
}
