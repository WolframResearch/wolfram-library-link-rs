...
pub struct st_WolframLibraryData {
    ...
    #[doc = "The content of the newly allocated block of memory is not initialized, remaining with indeterminate values."]
    #[doc = "If size is zero and in case of failure, a null pointer is returned."]
    ...
    #[doc = "WL_free, otherwise, the results are undefined."]
    #[doc = "If there is not enough memory, the old memory block is not freed and null pointer is returned."]
    #[doc = "In case that ptr is a null pointer, the function behaves like WL_malloc, assigning a new block of new_size bytes"]
    #[doc = "and returning a pointer to its beginning."]
    #[doc = "If new_size is zero, a null pointer is returned (in which case the old memory block may not be freed)."]
    ...
    #[doc = "freed with WL_free, otherwise, the results are undefined."]
    #[doc = "If there is not enough memory, the old memory block is not freed and null pointer is returned."]
    #[doc = "In case that ptr is a null pointer, the function behaves like WL_malloc_aligned, assigning a new block of"]
    #[doc = "new_size bytes and returning a pointer to its beginning."]
    #[doc = "If new_size is zero, a null pointer is returned (in which case the old memory block may not be freed)."]
    ...
    #[doc = "WL_realloc_aligned. If ptr does not point to a block of memory allocated with the above functions, it causes"]
    #[doc = "undefined behavior. If ptr is a null pointer, the function does nothing."]
    pub WL_free:
...
fn bindgen_test_layout_st_WolframLibraryData() {
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<st_WolframLibraryData>())).WL_malloc as *const _
                as usize
        },
        416usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<st_WolframLibraryData>())).WL_malloc_aligned
                as *const _ as usize
        },
        424usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<st_WolframLibraryData>())).WL_realloc as *const _
                as usize
        },
        432usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<st_WolframLibraryData>())).WL_realloc_aligned
                as *const _ as usize
        },
        440usize,
        concat!(
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<st_WolframLibraryData>())).WL_free as *const _ as usize
        },
        448usize,
        concat!(
            "Offset of field: ",
